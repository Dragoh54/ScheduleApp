...
public class UpdateMeetingStatusCommandHandler : IRequestHandler<UpdateMeetingStatusCommand, MeetingWithParticipantsResponseDto>
{
    ...
    public async Task<MeetingWithParticipantsResponseDto> Handle(UpdateMeetingStatusCommand request, CancellationToken cancellationToken)
    {
