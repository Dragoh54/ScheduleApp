...
public class UpdateMeetingInformationCommandHandler : IRequestHandler<UpdateMeetingInformationCommand, MeetingWithParticipantsResponseDto>
{
    public UpdateMeetingInformationCommandHandler(
    ...
    public async Task<MeetingWithParticipantsResponseDto> Handle(UpdateMeetingInformationCommand request, CancellationToken cancellationToken)
    {
