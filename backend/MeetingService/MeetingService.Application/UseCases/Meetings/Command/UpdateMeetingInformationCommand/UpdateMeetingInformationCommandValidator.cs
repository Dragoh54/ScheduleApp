...
public class UpdateMeetingInformationCommandValidator : AbstractValidator<UpdateMeetingInformationCommand>
{
    public UpdateMeetingInformationCommandValidator()
    {
        RuleFor(x => x.Id)
