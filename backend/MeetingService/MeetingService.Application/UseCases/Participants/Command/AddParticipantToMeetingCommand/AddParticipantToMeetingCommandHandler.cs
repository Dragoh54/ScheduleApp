...
public class AddParticipantToMeetingCommandHandler : IRequestHandler<AddParticipantToMeetingCommand, ParticipantWithMeetingResponseDto>
{
    public AddParticipantToMeetingCommandHandler(
    ...
    public async Task<ParticipantWithMeetingResponseDto> Handle(AddParticipantToMeetingCommand request, CancellationToken cancellationToken)
    {
