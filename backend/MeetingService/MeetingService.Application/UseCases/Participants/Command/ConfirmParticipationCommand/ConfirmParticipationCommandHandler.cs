...
public class ConfirmParticipationCommandHandler : IRequestHandler<ConfirmParticipationCommand, ParticipantWithMeetingResponseDto>
{
    public ConfirmParticipationCommandHandler(
