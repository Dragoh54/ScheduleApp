...
public class RemoveParticipantFromMeetingCommandHandler : IRequestHandler<RemoveParticipantFromMeetingCommand, ParticipantWithMeetingResponseDto>
{
    public RemoveParticipantFromMeetingCommandHandler(
    ...
    public async Task<ParticipantWithMeetingResponseDto> Handle(RemoveParticipantFromMeetingCommand request, CancellationToken cancellationToken)
    {
